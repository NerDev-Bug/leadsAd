<template>
    <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        ...
        >
            ...
            <!-- Modal Title -->
            <h2 class="text-2xl sm:text-3xl font-bold text-center mb-6 text-gray-800">Add Career Posting</h2>
            <!-- Career Form -->
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <textarea v-model="form.details" @input="handleInput('details')"
                            ...
                            placeholder="Enter the subsidiary or department this position belongs to"
                            required></textarea>
                    </div>
...
async function submitForm() {
    ...
    router.post('/careers', payload, {
        onSuccess: () => {
            ...
            Swal.fire({
                title: 'Success!',
                text: 'Career posting added successfully!',
                icon: 'success',
